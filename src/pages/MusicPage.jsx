      ...
      try {
        ...
        setTimeout(() => {
          const mockData = [
            ...
            { id: 8, title: 'Chúa sống lại rồi', video_url: 'https://www.youtube.com/watch?v=r1WE0RLerbA&list=RDr1WE0RLerbA&start_radio=1&pp=ygUZbeG7q25nIGNow7phIHPhu5FuZyBs4bqhaaAHAQ%3D%3D', season: 'easter' },
          ];
