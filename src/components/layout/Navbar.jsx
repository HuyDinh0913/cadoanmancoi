...
//   const { navigate, isLoggedIn, logout, activePage } = useContext(AppContext);

//   const navLinks = [
//     { name: 'Trang Chủ', page: 'home' },
//     { name: 'Giới Thiệu', page: 'about' },
//     { name: 'Hoạt Động', page: 'activities' },
//     { name: 'Góc Âm Nhạc', page: 'music' },
//     { name: 'Tìm Bài Hát', page: 'song-search' },
//     { name: 'Tuyển Thành Viên', page: 'join' },
...
//         activePage === page ? 'text-gold-600' : 'text-navy-700'
...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { name: 'Tuyển Thành Viên', path: '/join' },
